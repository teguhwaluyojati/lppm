        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="/inputdatajabatan">Data Karyawan Lppm</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
                    ...
                    <span>Data Laporan/Penelitian</span>
                </a>
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="laporan_penelitian.php">Laporan Penelitian</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Karyawan Lppm ISTEK WIDURI</h1>
                    </div>
                    <!-- ================= CONTENT ================= -->
<div class="content-wrapper">
    <div class="page-header">
        <button class="btn btn-primary" onclick="toggleForm()">+ Tambah Karyawan</button>
    </div>

    <!-- FORM -->
    <div class="card mb-4" id="formDosen" style="display:none;">
        <div class="card-body">
            <h5 class="mb-3">Form Tambah Karyawan</h5>
            <form>
                <div class="form-row">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="mb-3">Daftar Nama Karyawan</h5>
...
<div class="d-flex justify-content-between align-items-center mt-3">
    <div>
        <span id="showingText">Menampilkan 1 - 5 dari total data karyawan</span>
    </div>
    <div>
...
function paginateTable() {
    ...
    document.getElementById("showingText").innerText =
        `Menampilkan ${startDisplay} - ${endDisplay} dari ${totalRows} data karyawan lppm`;
